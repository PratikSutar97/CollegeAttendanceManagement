...
public class CustomAdapter  extends BaseAdapter {
    ...
    public static ArrayList<StudentData> modelArrayList;
    public CustomAdapter(Context context, ArrayList<StudentData> modelArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.listview_items, null, true);
